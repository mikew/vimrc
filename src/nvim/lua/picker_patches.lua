...
-- https://github.com/folke/snacks.nvim/blob/454ba02d69347c0735044f159b95d2495fc79a73/lua/snacks/picker/source/git.lua#L47
-- https://github.com/folke/snacks.nvim/pull/1629
...
function M.grep(opts, ctx)
  ...
  local args =
    git_args(opts.args, 'grep', '--line-number', '--column', '--no-color', '-I')
...
local snacks_picker_source_git = require('snacks.picker.source.git')
snacks_picker_source_git.grep = M.grep
